...
@Component({
  selector: 'app-estudios-laboratorio-one',
  templateUrl: './estudios-laboratorio-one.component.html',
  styleUrls: ['./estudios-laboratorio-one.component.css'],
  providers: [  ProtocolosEndocrinosService, 
    { provide: AlertConfig }],
})
export class EstudiosLaboratorioOneComponent implements OnChanges {
