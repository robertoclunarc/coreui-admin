...
@Component({
  selector: 'app-riesgos-metabolicos-one',
  templateUrl: './riesgos-metabolicos-one.component.html',
  styleUrls: ['./riesgos-metabolicos-one.component.css'],
  providers: [  ProtocolosEndocrinosService, 
    { provide: AlertConfig }],
})
export class RiesgosMetabolicosOneComponent implements OnChanges {
