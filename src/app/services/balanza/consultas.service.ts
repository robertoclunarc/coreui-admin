console.log('service/balanza/consultas.services.ts');
import { Injectable } from '@angular/core';
import { HttpClient, HttpErrorResponse } from '@angular/common/http';
import { Observable, of, throwError } from 'rxjs';
//import { IConsultas, IConsultasConstraint, IFiltroConsulta, IvConsulta } from '../../models/consultas.model';
import { IConsultas,  IFiltroConsulta, IvConsulta } from '../../models/balanza/consultas.model';
...
export class ConsultasService {
  ...
  //private apiUrlConsultas : string = environment.apiUrlBalanza + 'consultas/';
  private apiUrlConsultas : string = environment.apiUrlBalanza + 'operaciones/';
  ...
  consultasOne(id: number) : Observable<IConsultas> { 
    ...
    return this.http.get<IConsultas>(this.apiUrlConsultas + 'balanzaconsultar/' + id)
			.pipe(
  ...
  consultaFilter(pesaje: IFiltroConsulta) : Observable<IvConsulta[]> { 
    let parametrosUrl = pesaje.idBoleto + '/' + pesaje.codigoMaterial + '/' + pesaje.tipoOperacion;
