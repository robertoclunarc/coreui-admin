...
export const environment = {
  production: false,
  // ===DESARROLLO
	apiUrlServMedico: 'http://10.50.188.40:3000/sist_epidemiologico/api/',/* 'http://localhost:3000/sist_epidemiologico/api/',*/
  ...
  archivosServidorLocal: 'http://10.50.188.40/servicio_medico/',
};
